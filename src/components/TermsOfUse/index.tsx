  ...
  return (
    ...
    >
      ...
      >
        ...
        <SubTitle fs="lg" margin="0 0 12px 0">
          개인정보 수집 및 이용에 대한 안내{' '}
          <Span color="brandColor" fw="semiBold">
            (필수)
          </Span>
        </SubTitle>
        <Grid
        ...
        >
          <Grid fs="xs">
            <MainTitle margin="0 0 10px 0">
              &lt; hang &gt;(&#39;https://hanging.kr&#39;이하
              &#39;hang&#39;)은(는) 「개인정보 보호법」 제30조에 따라 정보주체의
              개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수
              있도록 하기 위하여 다음과 같이 개인정보 처리방침을
              수립·공개합니다.
            </MainTitle>
            <Text margin="0 0 10px 0">
              ○ 이 개인정보처리방침은 2021년 8월 20부터 적용됩니다.
            </Text>
            <MainTitle>제1조(개인정보의 처리 목적)</MainTitle>
            <Text margin="0 0 10px 0">
              &lt; hang &gt;(&#39;https://hanging.kr&#39;이하
              &#39;hang&#39;)은(는) 다음의 목적을 위하여 개인정보를 처리합니다.
              처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지
              않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에
              따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다. 1.
            ...
            <MainTitle>제2조(개인정보의 처리 및 보유 기간)</MainTitle>
            <Text margin="0 0 10px 0">
              ① &lt; hang &gt;은(는) 법령에 따른 개인정보 보유·이용기간 또는
              정보주체로부터 개인정보를 수집 시에 동의받은 개인정보
              보유·이용기간 내에서 개인정보를 처리·보유합니다. ② 각각의 개인정보
              처리 및 보유 기간은 다음과 같습니다. 1.&lt;홈페이지 회원가입 및
              관리&gt; &lt;홈페이지 회원가입 및 관리&gt;와 관련한 개인정보는
            ...
            <Text margin="0 0 10px 0">
              ① 정보주체는 hang에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
              요구 등의 권리를 행사할 수 있습니다. ② 제1항에 따른 권리
              행사는hang에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라
              서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며
              hang은(는) 이에 대해 지체 없이 조치하겠습니다. ③ 제1항에 따른 권리
              ...
              수 없습니다. ⑥ hang은(는) 정보주체 권리에 따른 열람의 요구,
              정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가
              본인이거나 정당한 대리인인지를 확인합니다.
            </Text>
            <MainTitle>제4조(처리하는 개인정보의 항목 작성)</MainTitle>
            <Text margin="0 0 10px 0">
              ① &lt; hang &gt;은(는) 다음의 개인정보 항목을 처리하고 있습니다.
              1&lt; 홈페이지 회원가입 및 관리 &gt; 필수항목 : 휴대전화번호,
              비밀번호, 로그인ID, 성별 선택항목 : 서비스 이용 기록, 접속 로그,
              쿠키, 접속 IP 정보
            </Text>
            <MainTitle>제5조(개인정보의 파기)</MainTitle>
            <Text margin="0 0 10px 0">
              ① &lt; hang &gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
              ...
              hang &gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고, &lt; hang
              &gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
              2. 파기방법 전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적
              방법을 사용합니다
            </Text>
            <MainTitle>제6조(개인정보의 안전성 확보 조치)</MainTitle>
            <Text margin="0 0 10px 0">
              &lt; hang &gt;은(는) 개인정보의 안전성 확보를 위해 다음과 같은
              조치를 취하고 있습니다. 1. 정기적인 자체 감사 실시 개인정보 취급
              관련 안정성 확보를 위해 정기적(분기 1회)으로 자체 감사를 실시하고
              있습니다. 2. 해킹 등에 대비한 기술적 대책
              &lt;hang&gt;(&#39;hang&#39;)은 해킹이나 컴퓨터 바이러스 등에 의한
              개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고
              주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을
              설치하고 기술적/물리적으로 감시 및 차단하고 있습니다. 3.
              개인정보의 암호화 이용자의 개인정보는 비밀번호는 암호화 되어 저장
              및 관리되고 있어, 본인만이 알 수 있으며 중요한 데이터는 파일 및
            ...
            <Text margin="0 0 10px 0">
              ① hang 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
            ...
            <MainTitle>제8조 (개인정보 보호책임자)</MainTitle>
            <Text margin="0 0 10px 0">
              ① hang 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
            ...
            <MainTitle>제11조(개인정보 처리방침 변경)</MainTitle>
            <Text margin="0 0 10px 0">
              ① 이 개인정보처리방침은 2021년 8월 20부터 적용됩니다. ② 이전의
              개인정보 처리방침은 아래에서 확인하실 수 있습니다. 예시 ) - 20XX.
              X. X ~ 20XX. X. X 적용 (클릭) 예시 ) - 20XX. X. X ~ 20XX. X. X
              적용 (클릭) 예시 ) - 20XX. X. X ~ 20XX. X. X 적용 (클릭)
            </Text>
          </Grid>
        </Grid>
        <Button
