...
// types
import {SmsType, SignUpType, PauthType, DuplicateType, LoginType, SearchType, UserDetailType, GuideRequestType, DoGuideType, LikeToggleType, CreateTripEventType, DeleteTripEventType, UpdateProfileType, AgreePromiseType, RejectPromiseType, CancelPromiseType} from './ApiTypes';
// cookie
...
const apis = {
  ...
  Duplicate: (user: DuplicateType) => instance.post('/api/users/duplicate', user),
  ...
  // favorite
  LikeToggle: (targetPk: LikeToggleType) => instance.post('/api/like', targetPk),
  ...
  DeleteTripEvent: (tripId: DeleteTripEventType) => instance.delete('/api/mypage', { data: tripId }),
  GetMyPromise: () => instance.get('/api/mypage/promise'),
  UpdateProfile: (userInfo: UpdateProfileType) => instance.patch('/api/mypage', userInfo),
  AgreePromise: (id: AgreePromiseType) => instance.post('/api/mypage/make_promise', id),
  RejectPromise: (reqId: RejectPromiseType) => instance.patch('/api/mypage/reject_request', reqId),
  CancelPromise: (tripId: CancelPromiseType) => instance.patch('/api/mypage/reject_confirm', tripId),
